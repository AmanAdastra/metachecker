...
logger.add("./logs/prospect_logs/prospect_module.log", colorize=True, rotation=rotator.should_rotate, level=constants.LOG_LEVEL, format=fmt, enqueue=True, backtrace=True)
